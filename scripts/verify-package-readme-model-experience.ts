...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-bid': { kind: 'none', reason: 'Browser-side Bid UI plugin layer; Host Bid packages own every model-facing workflow input.' },
  ...
  'packages/web/web-search-tavily': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-web.' },
