...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, bid-docx-export-notice, bid-run-notice, command, command-input, compaction, context, manual-compaction, model-retry, steering, tool-call, turn-error, turn-max-tokens, turn-tail, unknown, user, workflow-run',
    hookContext: 'string',
    ...
    occupants: [
      'client-ui-bid BidRunNotice key \'bid-run-notice\'',
      'client-ui-bid BidDocxExportNotice key \'bid-docx-export-notice\'',
  ...
  },
  {
    ...
    kind: 'chain',
    scope: 'session',
    summary: 'Hard composer takeover chain for features that replace the ordinary composer, including the subagent read-only boundary.',
    doc: 'Hard composer takeover chain for features that replace the ordinary composer, including the subagent read-only boundary.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
  ...
  {
    key: 'conversation.composer.interaction',
    kind: 'chain',
    scope: 'session',
    summary: 'Structured pending interactions such as Question and Approval; the elected panel stacks above the ordinary InputBar.',
    doc: 'Structured pending interactions such as Question and Approval; the elected panel stacks above the ordinary InputBar.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
  ...
  {
    key: 'conversation.embedded.chat',
    kind: 'single',
    scope: 'session',
    summary: 'The current Session transcript mounted by a feature-owned view.',
    doc: 'The current Session transcript mounted by a feature-owned view.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.embedded.chat\', () => ctx.slots.register(\n      { name: \'conversation.embedded.chat\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:249',
  },
  {
    key: 'conversation.embedded.composer',
    kind: 'single',
    scope: 'session',
    summary: 'The same session composer mounted by a feature-owned view.',
    doc: 'The same session composer mounted by a feature-owned view.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.embedded.composer\', () => ctx.slots.register(\n      { name: \'conversation.embedded.composer\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Business references shown inside the composer card, separately from the text draft.',
    doc: 'Business references shown inside the composer card, separately from the text draft.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-bid BidComposerContext id \'bid-revision\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.input.context\', () => ctx.slots.register(\n      { name: \'conversation.input.context\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-bid BidStagePanel id \'bid\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-bid BidConfirmationModeControl id \'bid-confirmation-mode\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-bid BidWordExport id \'bid-word-export\'',
      'client-ui-bid BidReviewWorkbench id \'bid-review\'',
      'client-ui-bid BidDetails',
