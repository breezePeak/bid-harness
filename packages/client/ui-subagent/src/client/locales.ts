...
export const zh = {
  ...
  'section.running': '运行中（{count}）',
  'section.running.empty': '当前没有正在运行的子代理',
  'section.history': '历史记录（{count}）',
  'section.history.empty': '暂无历史记录',
  ...
  'running.quickOpen': '进入正在运行的子代理：{title}',
...
export const en: Record<SubagentKey, string> = {
  ...
  'section.running.empty': 'No subagents are running',
  'section.history': 'History ({count})',
  'section.history.empty': 'No history yet',
  ...
  'running.quickOpen': 'Open running subagent: {title}',
