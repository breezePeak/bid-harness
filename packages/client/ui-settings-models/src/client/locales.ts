...
export const en = {
  ...
  modelInput: 'Input capabilities',
  modelInputText: 'Text',
  modelInputImage: 'Image',
  modelInputInherited: 'Inherited',
  modelInputCustomized: 'Customized',
  resetModelInput: 'Restore inheritance',
  modelInputHint: '“Image” means this model can receive ImageBlock directly. The declaration must match the provider or gateway capability.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelInputText: '文本',
  modelInputImage: '图片',
  modelInputInherited: '继承默认值',
  modelInputCustomized: '已显式配置',
  resetModelInput: '恢复继承',
  modelInputHint: '“图片”表示该模型能够直接接收 ImageBlock。能力声明必须与实际 Provider 或网关能力一致。',
  addModel: '添加模型',
  removeModel: '删除模型',
