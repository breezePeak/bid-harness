 ...
 * selector-routed entry of the structured interaction chain, plus the
...
/** Select the pending Question for the structured interaction panel. */
 ...
 * composer into the structured interaction chain. Zero business face — data and verbs live
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.slots.inject('conversation.composer.interaction', () => ctx.slots.register(
    { name: 'conversation.composer.interaction', select: selectQuestion, locale: NS },
    QuestionComposer,
  ))
}
