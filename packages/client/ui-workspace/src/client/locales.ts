...
export const zh = {
  ...
  'delete.desc': '删除“{name}”会删除其下全部对话，但不会删除本地项目目录和项目文件。',
...
export const en = {
  ...
  'delete.desc': 'Deleting “{name}” deletes all of its conversations, but does not delete the local project directory or project files.',
