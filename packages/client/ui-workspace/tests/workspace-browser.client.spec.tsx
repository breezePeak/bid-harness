...
describe('WorkspaceBrowser', () => {
  ...
  it('confirms Workspace deletion, explains its data boundary, and blocks duplicate submission', async () => {
    ...
    expect(dialog.textContent).toContain('删除“Alpha”会删除其下全部对话')
    expect(dialog.textContent).toContain('不会删除本地项目目录和项目文件')
