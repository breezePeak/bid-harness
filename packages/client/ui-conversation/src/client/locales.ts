...
export const zh = {
  ...
  'todo.progress.unfinished': '{active} 未收尾',
  ...
  'queue.remove': '删除排队消息',
  'queue.discard': '放弃这条本地消息',
  'queue.steer': '插话发送',
  'queue.steer.unavailable': '仅运行中可插话发送',
  'queue.status.preparing': '准备中',
  'queue.status.submitting': '提交中',
  'queue.status.queued': '排队中',
  'queue.status.delivering': '投递中',
  'queue.status.unknown': '送达未知，请等待同步',
...
export const en = {
  ...
  'todo.progress.unfinished': '{active} unfinished',
