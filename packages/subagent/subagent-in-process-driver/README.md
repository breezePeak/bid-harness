...
An errored child result carries a bounded safe diagnostic containing only the durable LLM failure code. The provider message and payload remain in the child Session and are not copied into the parent result.
