...
export const OUTLINE_CONFIRMATION_ISSUES = {
  ...
  OUTLINE_SHARED_COMPLIANCE_DUPLICATE: sharedCoverage(), OUTLINE_SHARED_RESPONSE_POINT_UNKNOWN: sharedCoverage(),
  ...
  OUTLINE_SHARED_CONTAINER_RESPONSE_POINT_INVALID: sharedCoverage(), OUTLINE_SHARED_RESPONSE_POINT_CATALOG_MISMATCH: sharedCoverage(),
